...
public class EchoServer extends AbstractServer 
{
  ...
  synchronized protected void clientException(ConnectionToClient client, Throwable exception) {
	  // The reason we cannot specify what kind of client disconnects because when we come here, the
	  // ConnectionToClient class, it calls this clientException method, however it runs a method called
	  // close all which causes client to become null.
  ...
  public void handleMessageFromServerUI(String message) throws IOException
  {
	  ...
	  if (message.startsWith("#")) {
		  if (message.equals("#quit")) {
			  ...
			  System.out.println("The port you are on is: " + getPort());
		  } else {
